 ...
 * SM3 context setup
 */
void sm3_starts(sm3_context* ctx, int iv[8])
{
    ctx->total[0] = 0;
    ctx->total[1] = 0;
...
void sm3(unsigned char* input, int ilen,
    unsigned char output[32],int iv[8])
{
    sm3_context ctx;
 ...
 */
int sm3_file(char* path, unsigned char output[32],int iv[8])
{
    FILE* f;
    size_t n;
    sm3_context ctx;
 ...
 */
void sm3_hmac_starts(sm3_context* ctx, unsigned char* key, int keylen, int iv[8])
{
    int i;
 ...
 */
void sm3_hmac_finish(sm3_context* ctx, unsigned char output[32],int iv[8])
{
    int hlen;
    ...
    unsigned char output[32],int iv[8])
{
    ...
    sm3_hmac_starts(&ctx, key, keylen, iv );
    sm3_hmac_update(&ctx, input, ilen);
    sm3_hmac_finish(&ctx, output,iv);
